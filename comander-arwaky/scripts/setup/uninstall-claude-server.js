...
const getVersion = async () => {
    try {
        ...
        // Check multiple levels for version.js
        let versionPath = join(__dirname, 'version.js');
        if (!existsSync(versionPath)) {
            versionPath = join(__dirname, '..', 'version.js');
        }
        if (!existsSync(versionPath)) {
            versionPath = join(__dirname, '..', '..', 'version.js');
        }
        ...
        // Check multiple levels for package.json
